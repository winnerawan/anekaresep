...
public class Puding {
    ...
    public Puding(String id, String gambar, String judul,String kategori, String awal, String bahan, String cara, String keterangan, String akhir,String rate, String time) {
        this.id=id;
        this.gambar=gambar;
        this.judul=judul;
