...
public class Masakan {
    ...
    public Masakan(String id, String awal, String gambar, String judul, String kategori, String bahan, String cara, String keterangan, String akhir, String rate, String time) {
        this.id=id;
        this.awal=awal;
        this.gambar=gambar;
        this.judul=judul;
